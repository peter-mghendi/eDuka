...
<img src='assets/images/products/$set_row[1].jpg' id='images'>
  ...
  <div class='d-flex justify-content-between align-items-center'><div class='mx-auto'>
      ...
      <a href='$page?&list=cart&user=$user&product=$product' class='btn btn-sm btn-warning'><i class='fa fa-cart-plus' aria-hidden='true'></i> Add</a>
      <a href='$page?&list=wishlist&user=$user&product=$product' class='btn btn-sm btn-link'><i class='$wished fa-star' aria-hidden='true'></i></a>
  </div></div></div></div></div>";