...
<img src='assets/images/products/$set_row[1].jpg' id='images'>
  ...
  <div class='d-flex justify-content-between align-items-center'><div class='mx-auto'>
      ...
      <a class='btn btn-sm btn-warning' $wish_attrib><i class='fa fa-cart-plus' aria-hidden='true'></i> Add</a>
      <a class='btn btn-sm btn-link' $cart_attrib><i class='$wished fa-star' aria-hidden='true'></i></a>
  </div></div></div></div></div>";