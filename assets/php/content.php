...
<main role="main">
  ...
  <div class="album py-5 bg-light">
    ...
    <?php foreach ($productSets as $productSet){ $title = $productSet=='monthly'?date('F'):$productSet;
      ...
      echo "<div class='container-fluid product-set' id='$productSet'><div class='d-flex'><h3 class='set-title'>$title items</h3><h3 class='ml-auto'><small><a href='browse.php?&type'>SEE MORE <span class='fa fa-angle-double-right'></span></a></small></h3></div><hr><div class='row'>";
      $i = 0;
      $set_query = "SELECT * FROM products";
      $set_result = mysqli_query($db, $set_query) or die(mysqli_error($db));
